...
/** Buttons Definitions */
#define BUTTON_COUNT_TIMEOUT 400

/** IMU Mouse Definitions */
#define IMU_MAX_ROTATION_MAP 2000
#define IMU_MAX_ROTATION_WEIGHT 5000
#define IMU_MAX_ROTATION_MAP_X_MIN IMU_MAX_ROTATION_MAP * -1
#define IMU_MAX_ROTATION_MAP_X_MAX IMU_MAX_ROTATION_MAP
#define IMU_MAX_ROTATION_MAP_Y_MIN IMU_MAX_ROTATION_MAP * -1
#define IMU_MAX_ROTATION_MAP_Y_MAX IMU_MAX_ROTATION_MAP

#define IMU_MAX_ROTATION_WEIGHT_X_MIN IMU_MAX_ROTATION_WEIGHT * -1
#define IMU_MAX_ROTATION_WEIGHT_X_MAX IMU_MAX_ROTATION_WEIGHT
#define IMU_MAX_ROTATION_WEIGHT_Y_MIN IMU_MAX_ROTATION_WEIGHT * -1
#define IMU_MAX_ROTATION_WEIGHT_Y_MAX IMU_MAX_ROTATION_WEIGHT
#define IMU_MAX_ROTATION_WEIGHT_X 0.3
#define IMU_MAX_ROTATION_WEIGHT_Y 0.3
